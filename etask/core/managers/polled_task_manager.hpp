...
namespace etask::core::managers {
    ...
    */
    ...
    class polled_task_manager {
        /// @brief `capacity<Task, N>` normalization for a pack element - see detail::registry_traits.
        template<typename T>
    ...
    private:
        ...
        */
        static_assert(
            (not std::is_base_of_v<stateful_task<task_uid_t>, typename reg_t<Tasks>::type> && ...),
