...
*
* This class complements `etask::tools::envelope` by supporting a view-like access pattern
...
namespace etask::tools {
    ...
    */
    ...
    public:
        /**
        * @brief Constructs an envelope_view from a raw data pointer and its size.
        *
        ...
        *
        * @throws std::runtime_error If deserialization fails or size limits are exceeded.
        */
        ...
        */
        ...
        /**
        * @brief Returns the size of the viewed memory block in bytes.
        *
    ...
    private: 
        ...
        */
        ...
        /**
        * @brief Size of the envelope's memory block in bytes.
        *
...
#endif // ETASK_TOOLS_ENVELOPE_VIEW_HPP_