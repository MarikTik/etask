...
*/
//! etask:end doc file
#ifndef SYS_LED_BLINK_HPP_
#define SYS_LED_BLINK_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::led {
    ...
    */
    //! etask:end doc class
    class blink : public polled_task {
    public:
        /**
        * @brief Construct the task from its parameters.
        *
        * @param period_ms TODO: describe `period_ms`.
        * @param count TODO: describe `count`.
        * @param ctx The `context` shared by this task's scope (hardware handles / state).
        */
        blink(std::uint16_t period_ms, std::uint16_t count, context& ctx); //! etask:sig
        ...
        *           - blinked : std::uint16_t
        *         e.g. `return {blinked};` - the values are
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::led_blink;
        ...
        */
        using params = etools::meta::typelist<std::uint16_t, std::uint16_t>;
