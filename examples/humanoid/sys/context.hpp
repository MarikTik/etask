...
#include "head/context.hpp"  //! etask:item head
#include "arms/context.hpp"  //! etask:item arms
#include "legs/context.hpp"  //! etask:item legs
...
namespace sys {
    ...
    */
    ...
    struct context {
        ...
        head::context head;  //! etask:item head
        arms::context arms;  //! etask:item arms
        legs::context legs;  //! etask:item legs
        //! etask:end children
    };
} // namespace sys
