...
*/
//! etask:end doc file
#ifndef SYS_LEGS_LEFT_STEP_HPP_
#define SYS_LEGS_LEFT_STEP_HPP_
#include "../../task.hpp"
#include "context.hpp"
    ...
    */
    ...
    public:
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::legs_left_step;
        ...
        */
        using params = etools::meta::typelist<float, std::uint8_t>;

        /**
        * @brief Names the `legs.left` context this task receives.
        *
        ...
        */
        static constexpr etask::core::scope_index_t scope = 7;   // generated::scopes::legs_left
        //! etask:wire end
    };
} // namespace sys::legs::left
#endif // SYS_LEGS_LEFT_STEP_HPP_
