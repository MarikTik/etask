...
*/
#ifndef SYSTEM_ARMS_LEFT_CONTEXT_HPP_
#define SYSTEM_ARMS_LEFT_CONTEXT_HPP_
...
namespace system::arms::left {
    ...
    *
    * Injected by reference into every task in `system::arms::left`,
...
#endif // SYSTEM_ARMS_LEFT_CONTEXT_HPP_
