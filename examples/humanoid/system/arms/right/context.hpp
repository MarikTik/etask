...
*/
#ifndef SYSTEM_ARMS_RIGHT_CONTEXT_HPP_
#define SYSTEM_ARMS_RIGHT_CONTEXT_HPP_
...
namespace system::arms::right {
    ...
    *
    * Injected by reference into every task in `system::arms::right`,
...
#endif // SYSTEM_ARMS_RIGHT_CONTEXT_HPP_
