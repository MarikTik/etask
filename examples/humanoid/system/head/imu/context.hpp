...
*/
#ifndef SYSTEM_HEAD_IMU_CONTEXT_HPP_
#define SYSTEM_HEAD_IMU_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace system::head::imu {
    /**
    * @brief Shared state and hardware for the `imu` scope - inertial measurement unit
    *
    * Injected by reference into every task in `system::head::imu`,
...
#endif // SYSTEM_HEAD_IMU_CONTEXT_HPP_
