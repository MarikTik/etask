...
*/
#ifndef SYSTEM_LEGS_LEFT_CONTEXT_HPP_
#define SYSTEM_LEGS_LEFT_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace system::legs::left {
    /**
    * @brief Shared state and hardware for the `left` scope - a leg
    *
    * Injected by reference into every task in `system::legs::left`,
...
#endif // SYSTEM_LEGS_LEFT_CONTEXT_HPP_
