...
*/
#ifndef TASKS_ARMS_LEFT_CONTEXT_HPP_
#define TASKS_ARMS_LEFT_CONTEXT_HPP_

namespace tasks::arms::left {
    /**
    * @brief Shared state and hardware for the `left` scope - an articulated arm with a gripper
    *
    * Injected by reference into every task in `tasks::arms::left`;
...
#endif // TASKS_ARMS_LEFT_CONTEXT_HPP_
