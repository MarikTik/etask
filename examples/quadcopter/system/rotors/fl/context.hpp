...
*/
#ifndef SYSTEM_ROTORS_FL_CONTEXT_HPP_
#define SYSTEM_ROTORS_FL_CONTEXT_HPP_
...
namespace system::rotors::fl {
    ...
    *
    * Injected by reference into every task in `system::rotors::fl`,
...
#endif // SYSTEM_ROTORS_FL_CONTEXT_HPP_
