...
*/
#ifndef SYSTEM_ROTORS_FR_CONTEXT_HPP_
#define SYSTEM_ROTORS_FR_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace system::rotors::fr {
    /**
    * @brief Shared state and hardware for the `fr` scope.
    *
    * Injected by reference into every task in `system::rotors::fr`,
...
#endif // SYSTEM_ROTORS_FR_CONTEXT_HPP_
