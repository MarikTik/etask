...
*/
#ifndef SYSTEM_SENSORS_BARO_CONTEXT_HPP_
#define SYSTEM_SENSORS_BARO_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace system::sensors::baro {
    /**
    * @brief Shared state and hardware for the `baro` scope - barometric altimeter
    *
    * Injected by reference into every task in `system::sensors::baro`,
...
#endif // SYSTEM_SENSORS_BARO_CONTEXT_HPP_
