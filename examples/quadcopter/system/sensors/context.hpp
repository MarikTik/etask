...
*/
#ifndef SYSTEM_SENSORS_CONTEXT_HPP_
#define SYSTEM_SENSORS_CONTEXT_HPP_
...
namespace system::sensors {
    ...
    *
    * Injected by reference into every task in `system::sensors`,
...
#endif // SYSTEM_SENSORS_CONTEXT_HPP_
