...
*/
#ifndef SYSTEM_SENSORS_GPS_CONTEXT_HPP_
#define SYSTEM_SENSORS_GPS_CONTEXT_HPP_
...
namespace system::sensors::gps {
    ...
    *
    * Injected by reference into every task in `system::sensors::gps`,
...
#endif // SYSTEM_SENSORS_GPS_CONTEXT_HPP_
