...
*/
#ifndef SYSTEM_SENSORS_IMU_CONTEXT_HPP_
#define SYSTEM_SENSORS_IMU_CONTEXT_HPP_
...
namespace system::sensors::imu {
    ...
    *
    * Injected by reference into every task in `system::sensors::imu`,
...
#endif // SYSTEM_SENSORS_IMU_CONTEXT_HPP_
