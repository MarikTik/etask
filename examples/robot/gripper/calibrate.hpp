...
namespace tasks::gripper {
    ...
    */
    ...
    public:
        ...
        *
        * @param tolerance TODO: describe `tolerance`.
        * @param retries TODO: describe `retries`.
