...
#include <cstddef>
#include "../sys/instant/ping.hpp"
#include "../sys/oneshot/sample.hpp"
#include "../sys/polled/count_to.hpp"
#include "../sys/polled/never_ends.hpp"
#include "../sys/stateful/resumable.hpp"
...
namespace generated {
    ...
    *
    * Declared as `budget: polled:` in the schema. This tier's tasks reserve 3
    * slots in total, so the declaration saves 1 record against that worst
