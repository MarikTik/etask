...
#include "instant/context.hpp"  //! etask:item instant
#include "oneshot/context.hpp"  //! etask:item oneshot
#include "polled/context.hpp"  //! etask:item polled
#include "stateful/context.hpp"  //! etask:item stateful
...
namespace sys {
    ...
    */
    ...
    struct context {
        ...
        instant::context instant;  //! etask:item instant
        oneshot::context oneshot;  //! etask:item oneshot
        polled::context polled;  //! etask:item polled
        stateful::context stateful;  //! etask:item stateful
        //! etask:end children
    };
} // namespace sys
