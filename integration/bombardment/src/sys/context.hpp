...
#include "swarm/context.hpp"  //! etask:item swarm
#include "hold/context.hpp"  //! etask:item hold
...
namespace sys {
    ...
    */
    ...
    struct context {
        ...
        swarm::context swarm;  //! etask:item swarm
        hold::context hold;  //! etask:item hold
        //! etask:end children
    };
} // namespace sys
