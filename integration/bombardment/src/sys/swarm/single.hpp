...
*/
//! etask:end doc file
#ifndef SYS_SWARM_SINGLE_HPP_
#define SYS_SWARM_SINGLE_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::swarm {
    //! etask:doc class 1a0740a7c60e
    /**
    * @brief occupy a polled record, one instance only
    *
    * A uid with no explicit `concurrency:`, so it reserves the default of
    * one slot. Present because the one-slot case is the common one in real
    * schemas and takes a different branch inside the manager than a
    * multi-slot uid does - see verify.py's `single_instance_refusal` check.
    *
    ...
    */
    //! etask:end doc class
    class single : public polled_task {
    public:
        /**
        ...
        */
        single(std::uint16_t ticks, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::swarm_single;
