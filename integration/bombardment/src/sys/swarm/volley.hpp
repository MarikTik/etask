...
*/
//! etask:end doc file
#ifndef SYS_SWARM_VOLLEY_HPP_
#define SYS_SWARM_VOLLEY_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::swarm {
    //! etask:doc class 2850545e07eb
    /**
    * @brief occupy a polled record, but only two at a time
    *
    * The narrow uid. Two live instances exhaust its own reservation while
    * the tier still holds four free records, which is the arrangement in
    * which `task_limit_reached` and `task_budget_exhausted` can be
    * distinguished by observation rather than by reading the source.
    *
    ...
    */
    //! etask:end doc class
    class volley : public polled_task {
    public:
        /**
        ...
        */
        volley(std::uint16_t ticks, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::swarm_volley;
