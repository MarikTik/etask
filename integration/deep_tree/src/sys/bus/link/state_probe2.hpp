//! etask:doc file 331dbdd5eb0c
/**
* @file state_probe2.hpp
*
...
*/
//! etask:end doc file
#ifndef SYS_BUS_LINK_STATE_PROBE2_HPP_
#define SYS_BUS_LINK_STATE_PROBE2_HPP_
#include "../../task.hpp"
#include "context.hpp"
...
namespace sys::bus::link {
    ...
    */
    ...
    public:
        ...
        */
        state_probe2(context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::bus_link_state_probe2;
        ...
        */
        ...
        /**
        * @brief Names the `bus.link` context this task receives.
        *
        ...
        */
        static constexpr etask::core::scope_index_t scope = 106;   // generated::scopes::bus_link
        //! etask:wire end
    };
} // namespace sys::bus::link
#endif // SYS_BUS_LINK_STATE_PROBE2_HPP_
