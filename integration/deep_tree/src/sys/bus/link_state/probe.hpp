...
*/
//! etask:end doc file
#ifndef SYS_BUS_LINK_STATE_PROBE_HPP_
#define SYS_BUS_LINK_STATE_PROBE_HPP_
#include "../../task.hpp"
#include "context.hpp"
    ...
    */
    ...
    public:
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::bus_link_state_probe;
        ...
        */
        ...
        /**
        * @brief Names the `bus.link_state` context this task receives.
        *
        ...
        */
        static constexpr etask::core::scope_index_t scope = 105;   // generated::scopes::bus_link_state
        //! etask:wire end
    };
} // namespace sys::bus::link_state
#endif // SYS_BUS_LINK_STATE_PROBE_HPP_
