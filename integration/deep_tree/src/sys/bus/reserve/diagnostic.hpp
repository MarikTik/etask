//! etask:doc file 2eab53e3e68f
/**
* @file diagnostic.hpp
*
* @brief pinned low - report this task's identity
*
...
*/
//! etask:end doc file
#ifndef SYS_BUS_RESERVE_DIAGNOSTIC_HPP_
#define SYS_BUS_RESERVE_DIAGNOSTIC_HPP_
#include "../../task.hpp"
#include "context.hpp"
...
namespace sys::bus::reserve {
    ...
    */
    //! etask:end doc class
    class diagnostic : public oneshot_task {
    public:
        /**
        ...
        */
        diagnostic(context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::bus_reserve_diagnostic;
...
#endif // SYS_BUS_RESERVE_DIAGNOSTIC_HPP_
