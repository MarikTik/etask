...
*/
//! etask:end doc file
#ifndef SYS_CENSUS_HPP_
#define SYS_CENSUS_HPP_
#include "task.hpp"
#include "context.hpp"
...
namespace sys {
    //! etask:doc class f9d376da80cc
    /**
    * @brief report the root task's identity
    *
    * Lives at the root, so `Naming.scope_parts` is empty for it and its
    * accessor is the document root's (`generated::scopes::system`). Everything
    * about its naming is the zero-length case of the rules the rest of the tree
    * exercises at length.
    *
    ...
    */
    //! etask:end doc class
    class census : public oneshot_task {
    public:
        /**
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::census;
