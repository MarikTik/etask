...
*/
//! etask:end doc file
#ifndef SYS_MESH_S0_N0_CONTEXT_HPP_
#define SYS_MESH_S0_N0_CONTEXT_HPP_
...
namespace sys::mesh::s0::n0 {
    //! etask:doc class d6e743451f57
    /**
    * @brief Shared state and hardware for the `n0` scope - one node within a segment
    *
    * Injected by reference into every task in `sys::mesh::s0::n0`,
...
#endif // SYS_MESH_S0_N0_CONTEXT_HPP_
