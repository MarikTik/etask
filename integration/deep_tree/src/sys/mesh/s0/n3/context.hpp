...
*/
//! etask:end doc file
#ifndef SYS_MESH_S0_N3_CONTEXT_HPP_
#define SYS_MESH_S0_N3_CONTEXT_HPP_
...
namespace sys::mesh::s0::n3 {
    //! etask:doc class d153df49329d
    /**
    * @brief Shared state and hardware for the `n3` scope - one node within a segment
    *
    * Injected by reference into every task in `sys::mesh::s0::n3`,
...
#endif // SYS_MESH_S0_N3_CONTEXT_HPP_
