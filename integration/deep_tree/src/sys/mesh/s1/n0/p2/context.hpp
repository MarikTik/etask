...
*/
//! etask:end doc file
#ifndef SYS_MESH_S1_N0_P2_CONTEXT_HPP_
#define SYS_MESH_S1_N0_P2_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace sys::mesh::s1::n0::p2 {
    //! etask:doc class 3f78cfd67e7e
    /**
    * @brief Shared state and hardware for the `p2` scope - one probe on a node
    *
    * Injected by reference into every task in `sys::mesh::s1::n0::p2`,
...
#endif // SYS_MESH_S1_N0_P2_CONTEXT_HPP_
