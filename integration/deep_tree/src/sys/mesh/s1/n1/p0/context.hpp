...
*/
//! etask:end doc file
#ifndef SYS_MESH_S1_N1_P0_CONTEXT_HPP_
#define SYS_MESH_S1_N1_P0_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace sys::mesh::s1::n1::p0 {
    //! etask:doc class e8f33e454ac4
    /**
    * @brief Shared state and hardware for the `p0` scope - one probe on a node
    *
    * Injected by reference into every task in `sys::mesh::s1::n1::p0`,
...
#endif // SYS_MESH_S1_N1_P0_CONTEXT_HPP_
