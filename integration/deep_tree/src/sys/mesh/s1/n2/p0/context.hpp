...
*/
//! etask:end doc file
#ifndef SYS_MESH_S1_N2_P0_CONTEXT_HPP_
#define SYS_MESH_S1_N2_P0_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace sys::mesh::s1::n2::p0 {
    //! etask:doc class 8f4a8708b602
    /**
    * @brief Shared state and hardware for the `p0` scope - one probe on a node
    *
    * Injected by reference into every task in `sys::mesh::s1::n2::p0`,
...
#endif // SYS_MESH_S1_N2_P0_CONTEXT_HPP_
