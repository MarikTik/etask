...
*/
//! etask:end doc file
#ifndef SYS_MESH_S2_N0_CONTEXT_HPP_
#define SYS_MESH_S2_N0_CONTEXT_HPP_
...
namespace sys::mesh::s2::n0 {
    //! etask:doc class 0f7e5e0c3498
    /**
    * @brief Shared state and hardware for the `n0` scope - one node within a segment
    *
    * Injected by reference into every task in `sys::mesh::s2::n0`,
...
#endif // SYS_MESH_S2_N0_CONTEXT_HPP_
