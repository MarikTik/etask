...
*/
//! etask:end doc file
#ifndef SYS_MESH_S2_N0_P1_CONTEXT_HPP_
#define SYS_MESH_S2_N0_P1_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace sys::mesh::s2::n0::p1 {
    //! etask:doc class 6b80c532f616
    /**
    * @brief Shared state and hardware for the `p1` scope - one probe on a node
    *
    * Injected by reference into every task in `sys::mesh::s2::n0::p1`,
...
#endif // SYS_MESH_S2_N0_P1_CONTEXT_HPP_
