...
*/
//! etask:end doc file
#ifndef SYS_MESH_S2_N3_P0_CONTEXT_HPP_
#define SYS_MESH_S2_N3_P0_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace sys::mesh::s2::n3::p0 {
    //! etask:doc class 1bda480fad80
    /**
    * @brief Shared state and hardware for the `p0` scope - one probe on a node
    *
    * Injected by reference into every task in `sys::mesh::s2::n3::p0`,
...
#endif // SYS_MESH_S2_N3_P0_CONTEXT_HPP_
