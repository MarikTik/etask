...
*/
//! etask:end doc file
#ifndef SYS_MESH_S3_N0_CONTEXT_HPP_
#define SYS_MESH_S3_N0_CONTEXT_HPP_
...
namespace sys::mesh::s3::n0 {
    //! etask:doc class 54de1bbfadf2
    /**
    * @brief Shared state and hardware for the `n0` scope - one node within a segment
    *
    * Injected by reference into every task in `sys::mesh::s3::n0`,
...
#endif // SYS_MESH_S3_N0_CONTEXT_HPP_
