...
*/
//! etask:end doc file
#ifndef SYS_MESH_S3_N2_P2_ARM_HPP_
#define SYS_MESH_S3_N2_P2_ARM_HPP_
#include "../../../../task.hpp"
#include "context.hpp"
    ...
    */
    ...
    public:
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::mesh_s3_n2_p2_arm;
        ...
        */
        ...
        /**
        * @brief Names the `mesh.s3.n2.p2` context this task receives.
        *
        ...
        */
        static constexpr etask::core::scope_index_t scope = 65;   // generated::scopes::mesh_s3_n2_p2
        //! etask:wire end
    };
} // namespace sys::mesh::s3::n2::p2
#endif // SYS_MESH_S3_N2_P2_ARM_HPP_
