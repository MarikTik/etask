...
*/
//! etask:end doc file
#ifndef SYS_MESH_S3_N3_CONTEXT_HPP_
#define SYS_MESH_S3_N3_CONTEXT_HPP_
...
namespace sys::mesh::s3::n3 {
    //! etask:doc class 1a39a2c08884
    /**
    * @brief Shared state and hardware for the `n3` scope - one node within a segment
    *
    * Injected by reference into every task in `sys::mesh::s3::n3`,
...
#endif // SYS_MESH_S3_N3_CONTEXT_HPP_
