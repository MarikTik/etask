...
*/
//! etask:end doc file
#ifndef SYS_MESH_S4_N0_P0_CONTEXT_HPP_
#define SYS_MESH_S4_N0_P0_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace sys::mesh::s4::n0::p0 {
    //! etask:doc class 523c8cdd2367
    /**
    * @brief Shared state and hardware for the `p0` scope - one probe on a node
    *
    * Injected by reference into every task in `sys::mesh::s4::n0::p0`,
...
#endif // SYS_MESH_S4_N0_P0_CONTEXT_HPP_
