...
*/
//! etask:end doc file
#ifndef SYS_MESH_S5_N1_P2_CONTEXT_HPP_
#define SYS_MESH_S5_N1_P2_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace sys::mesh::s5::n1::p2 {
    //! etask:doc class b6183d8aabc2
    /**
    * @brief Shared state and hardware for the `p2` scope - one probe on a node
    *
    * Injected by reference into every task in `sys::mesh::s5::n1::p2`,
...
#endif // SYS_MESH_S5_N1_P2_CONTEXT_HPP_
