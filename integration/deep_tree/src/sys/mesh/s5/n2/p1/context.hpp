...
*/
//! etask:end doc file
#ifndef SYS_MESH_S5_N2_P1_CONTEXT_HPP_
#define SYS_MESH_S5_N2_P1_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace sys::mesh::s5::n2::p1 {
    //! etask:doc class e7fe7342d575
    /**
    * @brief Shared state and hardware for the `p1` scope - one probe on a node
    *
    * Injected by reference into every task in `sys::mesh::s5::n2::p1`,
...
#endif // SYS_MESH_S5_N2_P1_CONTEXT_HPP_
