...
*/
//! etask:end doc file
#ifndef SYS_MESH_S5_N3_CONTEXT_HPP_
#define SYS_MESH_S5_N3_CONTEXT_HPP_
...
namespace sys::mesh::s5::n3 {
    //! etask:doc class 1b1275c33ce7
    /**
    * @brief Shared state and hardware for the `n3` scope - one node within a segment
    *
    * Injected by reference into every task in `sys::mesh::s5::n3`,
...
#endif // SYS_MESH_S5_N3_CONTEXT_HPP_
