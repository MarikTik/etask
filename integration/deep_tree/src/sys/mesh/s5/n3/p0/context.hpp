...
*/
//! etask:end doc file
#ifndef SYS_MESH_S5_N3_P0_CONTEXT_HPP_
#define SYS_MESH_S5_N3_P0_CONTEXT_HPP_
//! etask:managed child_includes - child subsystem context headers
//! etask:end child_includes

namespace sys::mesh::s5::n3::p0 {
    //! etask:doc class e12cfdd7a91d
    /**
    * @brief Shared state and hardware for the `p0` scope - one probe on a node
    *
    * Injected by reference into every task in `sys::mesh::s5::n3::p0`,
...
#endif // SYS_MESH_S5_N3_P0_CONTEXT_HPP_
