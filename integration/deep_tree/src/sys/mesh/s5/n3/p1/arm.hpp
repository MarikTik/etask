...
*/
//! etask:end doc file
#ifndef SYS_MESH_S5_N3_P1_ARM_HPP_
#define SYS_MESH_S5_N3_P1_ARM_HPP_
#include "../../../../task.hpp"
#include "context.hpp"
...
namespace sys::mesh::s5::n3::p1 {
    //! etask:doc class 0d9cf56b2c33
    /**
    * @brief arm this probe across ticks
    *
    * A polled tier in the fan-out, so the widened uid type is
    * exercised through the polled manager's registry and not
    * only through the oneshot one.
    *
    ...
    */
    ...
    public:
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::mesh_s5_n3_p1_arm;
        ...
        */
        ...
        /**
        * @brief Names the `mesh.s5.n3.p1` context this task receives.
        *
        ...
        */
        static constexpr etask::core::scope_index_t scope = 102;   // generated::scopes::mesh_s5_n3_p1
        //! etask:wire end
    };
} // namespace sys::mesh::s5::n3::p1
#endif // SYS_MESH_S5_N3_P1_ARM_HPP_
