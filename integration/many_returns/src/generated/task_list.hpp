...
#include <cstddef>
#include "../sys/nothing/acknowledge.hpp"
#include "../sys/nothing/report_status.hpp"
#include "../sys/scalars/unsigned_widths.hpp"
#include "../sys/scalars/signed_widths.hpp"
#include "../sys/scalars/plain_int.hpp"
#include "../sys/scalars/reals.hpp"
#include "../sys/scalars/flags.hpp"
#include "../sys/scalars/positional.hpp"
#include "../sys/wide/telemetry.hpp"
#include "../sys/keyed/measure.hpp"
#include "../sys/keyed/converge.hpp"
#include "../sys/keyed/classify.hpp"
...
namespace generated {
    ...
    */
    using polled_tasks = etools::meta::typelist<
        sys::nothing::acknowledge,
        sys::nothing::report_status,
        sys::scalars::unsigned_widths,
        sys::scalars::signed_widths,
        sys::scalars::plain_int,
        sys::scalars::reals,
        sys::scalars::flags,
        sys::scalars::positional,
        sys::wide::telemetry,
        sys::keyed::measure,
        sys::keyed::converge,
        sys::keyed::classify
    ...
    * 12 slots in total, so the declaration saves 10 records against that
