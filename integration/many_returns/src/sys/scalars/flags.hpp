...
*/
//! etask:end doc file
#ifndef SYS_SCALARS_FLAGS_HPP_
#define SYS_SCALARS_FLAGS_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::scalars {
    ...
    * @brief bool, both ways
    *
    * A bool is one byte on the wire but its C++ width is not fixed by the
    ...
    */
    ...
    public:
        ...
        *           - yes : bool
        *           - no : bool
        *         e.g. `return {yes, no};` - the values are
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::scalars_flags;
