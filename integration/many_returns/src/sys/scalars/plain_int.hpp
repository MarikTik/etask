...
*/
//! etask:end doc file
#ifndef SYS_SCALARS_PLAIN_INT_HPP_
#define SYS_SCALARS_PLAIN_INT_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::scalars {
    //! etask:doc class d303e7e0d97e
    /**
    * @brief the bare `int` alias, distinct from int32 in the schema
    *
    * `int` and `int32` are separate spellings that map to the same C++ type
    * and the same four bytes. Returned here so a divergence between the two
    * entries in TypeMap would show up as a wire difference rather than as
    * nothing at all.
    *
    ...
    */
    //! etask:end doc class
    class plain_int : public oneshot_task {
    public:
        /**
        ...
        */
        plain_int(context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::scalars_plain_int;
...
#endif // SYS_SCALARS_PLAIN_INT_HPP_
