...
*/
//! etask:end doc file
#ifndef SYS_SCALARS_REALS_HPP_
#define SYS_SCALARS_REALS_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::scalars {
    //! etask:doc class b7d6f44fed5e
    /**
    * @brief float and double, at values that are not round
    *
    * Neither value is exactly representable at the other's width, so a float
    * silently widened to a double (or the reverse) changes the number rather
    * than preserving it.
    *
    ...
    */
    //! etask:end doc class
    class reals : public oneshot_task {
    public:
        /**
        ...
        *           - f32 : float
        *           - f64 : double
        *         e.g. `return {f32, f64};` - the values are
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::scalars_reals;
