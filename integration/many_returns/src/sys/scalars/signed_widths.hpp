//! etask:doc file eb15e0018a74
/**
* @file signed_widths.hpp
*
...
*/
//! etask:end doc file
#ifndef SYS_SCALARS_SIGNED_WIDTHS_HPP_
#define SYS_SCALARS_SIGNED_WIDTHS_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::scalars {
    //! etask:doc class f2a0ac8eb393
    /**
    * @brief int8/16/32/64, all negative
    *
    * All four values are negative. Sign extension is the one integer bug that
    * survives a correct width: read int8 -1 as uint8 and you get 255, which
    * is the right byte and the wrong number, so only a signed expectation on
    * the host catches it.
    *
    ...
    */
    //! etask:end doc class
    class signed_widths : public oneshot_task {
    public:
        /**
        ...
        */
        signed_widths(context& ctx); //! etask:sig
        ...
        *           - i32 : std::int32_t
        *           - i64 : std::int64_t
        *         e.g. `return {i8, i16, i32, i64};` - the values are
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::scalars_signed_widths;
...
#endif // SYS_SCALARS_SIGNED_WIDTHS_HPP_
