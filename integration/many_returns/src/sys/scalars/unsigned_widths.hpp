//! etask:doc file 81de3a398d22
/**
* @file unsigned_widths.hpp
*
...
*/
//! etask:end doc file
#ifndef SYS_SCALARS_UNSIGNED_WIDTHS_HPP_
#define SYS_SCALARS_UNSIGNED_WIDTHS_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::scalars {
    //! etask:doc class 0ddbcb45b922
    /**
    * @brief uint8/16/32/64 in one shape, ascending
    *
    * Ascending widths in one shape, so a field read at the wrong width walks
    * off into its neighbour and the mismatch shows in every value after it -
    * the failure mode a per-field test cannot produce.
    *
    ...
    */
    //! etask:end doc class
    class unsigned_widths : public oneshot_task {
    public:
        /**
        ...
        */
        unsigned_widths(context& ctx); //! etask:sig
        ...
        *           - u32 : std::uint32_t
        *           - u64 : std::uint64_t
        *         e.g. `return {u8, u16, u32, u64};` - the values are
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::scalars_unsigned_widths;
...
#endif // SYS_SCALARS_UNSIGNED_WIDTHS_HPP_
