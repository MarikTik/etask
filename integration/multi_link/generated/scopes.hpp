...
#include "../sys/bulk/context.hpp"
#include "../sys/telemetry/context.hpp"
#include "../sys/shared/context.hpp"
...
namespace generated::scopes {
    ...
    */
    ...
    /**
    * @brief The `context` of `bulk`.
    *
    * Bound as the scope argument of every task in it (see
    * `etask::core::scoped_task_unpack_adapter`). Inlines to a member offset
    * into the one context tree - there is no lookup and no indirection.
    */
    [[nodiscard]] inline sys::bulk::context& bulk() noexcept
    {
        return detail::tree().bulk;
    }

    /**
    * @brief The `context` of `telemetry`.
    *
    * Bound as the scope argument of every task in it (see
    * `etask::core::scoped_task_unpack_adapter`). Inlines to a member offset
    * into the one context tree - there is no lookup and no indirection.
    */
    [[nodiscard]] inline sys::telemetry::context& telemetry() noexcept
    {
        return detail::tree().telemetry;
    }

    /**
    * @brief The `context` of `shared`.
    *
    * Bound as the scope argument of every task in it (see
    * `etask::core::scoped_task_unpack_adapter`). Inlines to a member offset
    * into the one context tree - there is no lookup and no indirection.
    */
    [[nodiscard]] inline sys::shared::context& shared() noexcept
    {
        return detail::tree().shared;
    }
...
namespace etask::core {
    ...
    /// @brief `bulk`. @see generated::scopes::bulk
    template<> struct scope_binding<1> {
        [[nodiscard]] static sys::bulk::context& get() noexcept
        { return generated::scopes::bulk(); }
    };

    /// @brief `telemetry`. @see generated::scopes::telemetry
    template<> struct scope_binding<2> {
        [[nodiscard]] static sys::telemetry::context& get() noexcept
        { return generated::scopes::telemetry(); }
    };

    /// @brief `shared`. @see generated::scopes::shared
    template<> struct scope_binding<3> {
        [[nodiscard]] static sys::shared::context& get() noexcept
        { return generated::scopes::shared(); }
    };
