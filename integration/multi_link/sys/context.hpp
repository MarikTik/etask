...
#include "bulk/context.hpp"  //! etask:item bulk
#include "telemetry/context.hpp"  //! etask:item telemetry
#include "shared/context.hpp"  //! etask:item shared
...
namespace sys {
    ...
    */
    ...
    struct context {
        ...
        bulk::context bulk;  //! etask:item bulk
        telemetry::context telemetry;  //! etask:item telemetry
        shared::context shared;  //! etask:item shared
        //! etask:end children
    };
} // namespace sys
