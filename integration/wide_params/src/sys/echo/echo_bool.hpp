...
*/
//! etask:end doc file
#ifndef SYS_ECHO_ECHO_BOOL_HPP_
#define SYS_ECHO_ECHO_BOOL_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::echo {
    ...
    * @brief echo a bool
    *
    * One wire byte, but not a free one: `bool` is the only type whose C++
    * representation is not the value the peer sent. Python's struct '?'
    ...
    */
    ...
    public:
        ...
        */
        echo_bool(bool v, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::echo_echo_bool;
        ...
        */
        using params = etools::meta::typelist<bool>;
