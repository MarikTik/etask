//! etask:doc file af65b2939daa
/**
* @file echo_double.hpp
*
* @brief echo a double
*
...
*/
//! etask:end doc file
#ifndef SYS_ECHO_ECHO_DOUBLE_HPP_
#define SYS_ECHO_ECHO_DOUBLE_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::echo {
    ...
    * @brief echo a double
    *
    * The type the truncation bug hides in. An embedded toolchain that
    * silently maps `double` to `float` - a real ESP8266/AVR default - keeps
    ...
    */
    ...
    public:
        ...
        */
        echo_double(double v, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::echo_echo_double;
        ...
        */
        using params = etools::meta::typelist<double>;
...
#endif // SYS_ECHO_ECHO_DOUBLE_HPP_
