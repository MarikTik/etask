...
*/
//! etask:end doc file
#ifndef SYS_ECHO_ECHO_INT16_HPP_
#define SYS_ECHO_ECHO_INT16_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::echo {
    ...
    */
    //! etask:end doc class
    class echo_int16 : public oneshot_task {
    public:
        /**
        ...
        */
        echo_int16(std::int16_t v, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::echo_echo_int16;
        ...
        */
        using params = etools::meta::typelist<std::int16_t>;
...
#endif // SYS_ECHO_ECHO_INT16_HPP_
