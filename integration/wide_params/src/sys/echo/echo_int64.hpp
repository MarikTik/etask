...
*/
//! etask:end doc file
#ifndef SYS_ECHO_ECHO_INT64_HPP_
#define SYS_ECHO_ECHO_INT64_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::echo {
    ...
    * @brief echo an int64
    *
    * The first type wider than the target's word. An Xtensa build packs
    * this as two 32-bit halves; a host packs it as one 64-bit store. The
    ...
    */
    ...
    public:
        ...
        */
        echo_int64(std::int64_t v, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::echo_echo_int64;
        ...
        */
        using params = etools::meta::typelist<std::int64_t>;
...
#endif // SYS_ECHO_ECHO_INT64_HPP_
