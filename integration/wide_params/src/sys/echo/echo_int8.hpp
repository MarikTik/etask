...
*/
//! etask:end doc file
#ifndef SYS_ECHO_ECHO_INT8_HPP_
#define SYS_ECHO_ECHO_INT8_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::echo {
    ...
    */
    //! etask:end doc class
    class echo_int8 : public oneshot_task {
    public:
        /**
        ...
        */
        echo_int8(std::int8_t v, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::echo_echo_int8;
        ...
        */
        using params = etools::meta::typelist<std::int8_t>;
