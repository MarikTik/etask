//! etask:doc file 93b5f7e086c8
/**
* @file echo_uint16.hpp
*
* @brief echo a uint16
*
...
*/
//! etask:end doc file
#ifndef SYS_ECHO_ECHO_UINT16_HPP_
#define SYS_ECHO_ECHO_UINT16_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::echo {
    ...
    */
    //! etask:end doc class
    class echo_uint16 : public oneshot_task {
    public:
        /**
        ...
        */
        echo_uint16(std::uint16_t v, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::echo_echo_uint16;
...
#endif // SYS_ECHO_ECHO_UINT16_HPP_
