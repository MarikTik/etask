//! etask:doc file 9c998f0deeb4
/**
* @file echo_uint32.hpp
*
* @brief echo a uint32
*
...
*/
//! etask:end doc file
#ifndef SYS_ECHO_ECHO_UINT32_HPP_
#define SYS_ECHO_ECHO_UINT32_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::echo {
    ...
    */
    //! etask:end doc class
    class echo_uint32 : public oneshot_task {
    public:
        /**
        ...
        */
        echo_uint32(std::uint32_t v, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::echo_echo_uint32;
...
#endif // SYS_ECHO_ECHO_UINT32_HPP_
