//! etask:doc file 97f56ad77a55
/**
* @file echo_uint64.hpp
*
* @brief echo a uint64
*
...
*/
//! etask:end doc file
#ifndef SYS_ECHO_ECHO_UINT64_HPP_
#define SYS_ECHO_ECHO_UINT64_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::echo {
    ...
    */
    //! etask:end doc class
    class echo_uint64 : public oneshot_task {
    public:
        /**
        ...
        */
        echo_uint64(std::uint64_t v, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::echo_echo_uint64;
        ...
        */
        using params = etools::meta::typelist<std::uint64_t>;
...
#endif // SYS_ECHO_ECHO_UINT64_HPP_
