...
*/
//! etask:end doc file
#ifndef SYS_ECHO_ECHO_UINT8_HPP_
#define SYS_ECHO_ECHO_UINT8_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::echo {
    ...
    */
    //! etask:end doc class
    class echo_uint8 : public oneshot_task {
    public:
        /**
        ...
        */
        echo_uint8(std::uint8_t v, context& ctx); //! etask:sig
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::echo_echo_uint8;
...
#endif // SYS_ECHO_ECHO_UINT8_HPP_
