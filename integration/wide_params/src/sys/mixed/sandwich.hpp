...
*/
//! etask:end doc file
#ifndef SYS_MIXED_SANDWICH_HPP_
#define SYS_MIXED_SANDWICH_HPP_
#include "../task.hpp"
#include "context.hpp"
...
namespace sys::mixed {
    ...
    * @brief uint8, double, uint8 - the canonical padding trap
    *
    * As a C struct this is 1 + 7 padding + 8 + 1 + 7 tail = 24 bytes; flat
    ...
    */
    ...
    public:
        ...
        *
        * @param head The value to echo back unchanged.
        * @param body The value to echo back unchanged.
        * @param tail The value to echo back unchanged.
        * @param ctx The `context` shared by this task's scope (hardware handles / state).
        */
        sandwich(std::uint8_t head, double body, std::uint8_t tail, context& ctx); //! etask:sig
        ...
        *           - body : double
        *           - tail : std::uint8_t
        *         e.g. `return {head, body, tail};` - the values are
        ...
        */
        ...
        static constexpr global::task_id uid = global::task_id::mixed_sandwich;
        ...
        */
        using params = etools::meta::typelist<std::uint8_t, double, std::uint8_t>;
