# tools/tests/schemav2/test_wire_tables_agree.py
...
from schemav2.models.status_code import StatusCode as SchemaStatus
...
def test_the_generator_table_matches_the_cpp_header():
    ...
    assert not missing, (
        f"schemav2.models.status_code is out of step with status_code.hpp: {missing}"
    )
